...
<html lang="en">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
		      <a class="navbar-brand" href="index.php"><span class="flaticon-pizza-1 mr-1"></span>Pizzas<br><small>Delicious</small></a>
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 col-sm-12 ftco-animate">
              ...
              <p class="mb-4 mb-md-5">new york style cheese pizza</p>
              <p><a href="order.php" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a></p>
            </div>
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 col-sm-12 order-md-last ftco-animate">
              ...
              <p class="mb-4 mb-md-5">sicilian style pepperoni pizza</p>
              <p><a href="order.php" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a></p>
            </div>
            <div class="col-md-6 ftco-animate">
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              ...
              <p class="mb-4 mb-md-5"> we serve quality food at reasonable prices, for take out or dining in, delivery, and catering are also available</p>
              <p><a href="order.php" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a></p>
            </div>
	    		...
	    		<div class="info">
	    			<div class="row no-gutters">
	    				...
	    				<div class="col-md-4 d-flex ftco-animate">
	    					...
	    					<div class="text">
	    						<h3>800 N State College Blvd</h3>
